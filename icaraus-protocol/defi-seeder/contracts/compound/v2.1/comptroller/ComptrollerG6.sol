...
import "./storage/ComptrollerV5Storage.sol";
import "../interfaces/ComptrollerInterface.sol";

import "../reporters/ComptrollerErrorReporter.sol";
import "../maths/ExponentialNoError.sol";
import "../CToken.sol";
import "../oracles/PriceOracle.sol";
import "./uni/Unitroller.sol";
...
contract ComptrollerG6 is ComptrollerV5Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError {
     ...
     */
    function redeemVerify(address cToken, address redeemer, uint redeemAmount, uint redeemTokens) external override pure {
        // Shh - currently unused
        cToken;
        redeemer;
    ...
    function _supportMarket(CToken cToken) external returns (uint) {
      ...
      Market storage _market =  markets[address(cToken)];
        _market.isListed = true;
        _market.isComped = false;

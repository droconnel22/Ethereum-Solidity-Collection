...
interface IMASTERCHEF {
    ...
    function poolInfo(uint256) external view returns(address lpToken, uint256 allocPoint, uint256 lastRewardBlock,uint256 accPicklePerShare);
    ...
    function updatePool(uint256 _piid) external;
